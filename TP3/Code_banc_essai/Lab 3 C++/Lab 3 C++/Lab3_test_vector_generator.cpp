...
std::vector<std::vector<u32>> genererValeursEntree32bitsAleatoires(unsigned nEdgeCases, unsigned nEntrees, unsigned nValeurs);

int main()
{
	// Initialization
	initialisationGenerateurNombresAleatoires();
	genererValeursEntree32bitsAleatoires(8, 3, NOMBRE_VALEURS);
	...
	//{
	//	inSigma0[i] = ((RAND_MAX * rand() + rand()) % (valMax - 1)) + 1; //on génère entre 1 et 2^32-2 inclus
	//}
	//for (unsigned int i = 0; i < 64; ++i)
	//{
	...
	//for (unsigned int i = 2; i < 64; ++i)
	//{
	//	inSigma1[i] = ((RAND_MAX * rand() + rand()) % (valMax - 1)) + 1; //on génère entre 1 et 2^32-2 inclus
	//}
	//for (unsigned int i = 0; i < 64; ++i)
	//{
	...
	//for (unsigned int i = 2; i < 64; ++i)
	//{
	//	inSigma2[i] = ((RAND_MAX * rand() + rand()) % (valMax - 1)) + 1; //on génère entre 1 et 2^32-2 inclus
	//}
	//for (unsigned int i = 0; i < 64; ++i)
	//{
	...
	//for (unsigned int i = 2; i < 64; ++i)
	//{
	//	inSigma3[i] = ((RAND_MAX * rand() + rand()) % (valMax - 1)) + 1; //on génère entre 1 et 2^32-2 inclus
	//}
	//for (unsigned int i = 0; i < 64; ++i)
	//{
...
std::vector<std::vector<u32>> genererValeursEntree32bitsAleatoires(unsigned nEdgeCases, unsigned nEntrees, unsigned nValeurs)
{
	std::vector<std::vector<u32>> vecteurDEntrees;
	for (int i = 0; i < nEntrees; i++)
	{
		std::vector<u32> valeurs;
		for (int j = nEdgeCases; j < nValeurs; j++)
		{
			valeurs.push_back(((RAND_MAX * rand() + rand()) % (valMax + 1)));
		}
		valeurs.push_back(((RAND_MAX * rand() + rand()) % (valMax + 1)));
	}
